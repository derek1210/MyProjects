...
int inode_bitmap[32];
int dir_blocks[128][15]; //list of corresponding block num [9, 10, 11, 12]
int dir_inodes[32]; // list of inodes of dirs [2,12,13,16,.....]
int num_dir; //number of all dirs/size of dir_inodes and all_dir
...
struct ext2_dir_entry *find_entry(int block_num, char* dir_name);
...
int* block_of_dir_inode(int inode_num);
...
struct ext2_dir_entry *validate_path(char* path, char* src, unsigned char file_type);
...
// struct ext2_dir_entry *find_entry(char* path);
