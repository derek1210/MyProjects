...
struct SceneNode {
	...
	SceneNode(Material *posx, Material *negx, Material *posy, Material *negy, Material *posz, Material *negz):
		obj(NULL), mat(NULL), posx(posx), negx(negx), posy(posy), negy(negy), posz(posz), negz(negz) {} 
