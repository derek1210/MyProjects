...
struct Material {
	...
	Material(unsigned long int texture_width, long int texture_height, unsigned char *rarray, unsigned char *garray, unsigned char *barray ):
		texture_width(texture_width), texture_height(texture_height), rarray(rarray), garray(garray), barray(barray) 
		{texture_map = true;}
